    ...
    >
      <div className="flex items-center justify-center w-screen h-screen py-auto my-auto">
        ...
        <p id="aboutParagraph">
          ...
          approach challenges from multiple angles, combining technical know-how
          with marketing savvy and design thinking. <br></br>
          <br></br>
          I'm passionate about leveraging emerging technologies, including AI
          and Large Language Models (LLMs), to create innovative solutions that
          not only meet technical requirements but also resonate with end-users
          through thoughtful design and targeted marketing strategies. Currently
          expanding my technical skills through a Fullstack Coding program at
          Vanderbilt University, I continuously seek to integrate my growing
          programming knowledge with my established expertise in sales,
